...
- traps (Stallman's identification of proprietary softare as a trap, Lori Emerson's understanding of ubicomp and the invisible GUI as traps, Darnton and Fitzpatrick's articulations of the current trap in scholarly publishing, Darnton's analysis of Google Books as a potential trap)
...
advocated eclectic editing. divided text into substantive component and accidentals. disputed the prevailing idea of the copy-text, or a chosen text that serves as the basis of an edition, thinking the editor should work toward a more idealized version of the text based on substantive components. the copy-text would really only be used as a tie-breaker if the editor's vision of the text does not apply to a particular discrepency (called "indifference". The eclectic appraoch is usually associated with authorial intentionality because in look at the substantive component you're decidiing what the author indended to be there as opposed to accidentals, which the author didn't care about.

Bowers

Applied Greg's appraoch (electic) in practice (Greg didn't live long enough). Believed the bibliographer should study the book as an object and that the signs in the book should be considered merely as icons independent of semantics. (descriptive bibliography, didn't consider historical bibliography to be part of bibliography). G. Thomas Tanselte continued these eclectic practices in the 70s.
...
- news has always been unstable (tells story of trying to find a printable news story and being told that a rape/homocide was unprinable because the victims were black)
...
the sotry eof the stability of print began with printers in the 16th century who even then benefitted from the perception that print was stable
...
"the effect is not hte immediate apprehension of knowledge, but ... estrangement and defamiliarization"
...
hermaneutics isn't concered with the kind of methology you see in science, but it is concerened with truth reached through a dialectic process
...
- the goal is fundamentally different. science looks for one answer. the purpose of criticism is actually the oppisite, to generate multiple meanings in a dialogue with one another. the more fecund an approach in generate debate, the more successful

ramsey's way forward here is to acknowledge the way "normal" criticism deforms the text. all readings are based on a heruistic approach to the text by definition. text analysis provides another way of deforming or carving a path through a text that isn't necessarily less valid
- if you say "turn to page 112" or if you say "consider the novel in relation to Jacobin theater," you're deforming the text
- witgenstein: "we see an aspect that further enables discussion and debate"
